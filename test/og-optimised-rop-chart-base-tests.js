...
function runBaseTests() {
  og_optimised_rop_chart_1 = document.getElementById('og_optimised_rop_chart_1');

  suite('Base Automation Tests for og-optimised-rop-chart', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-optimised-rop-chart fixture is created', function() {
      assert.isTrue(document.getElementById('og_optimised_rop_chart_1') !== null);
    });
